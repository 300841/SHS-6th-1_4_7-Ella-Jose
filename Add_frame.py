...
def frame(original_image, color, frame_width):
    ...
    """
    #set the width of the frame of the rounded corners
    ...
    drawing_layer.rectangle((thickness,height,width,height), fill=(r,g,b,255))
    drawing_layer.rectangle((thickness,width,width,height), fill=(r,g,b,255))
...
def frame_all_images(directory=None, color=(0,0,0), width=0.10):
